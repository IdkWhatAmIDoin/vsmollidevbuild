...
class PlayState extends MusicBeatState
{
	...
	var detailsText:String = "Rap battlin' with some random while Molli just watches";
	var detailsPausedText:String = "...why is the time paused";
	#end
	...
	override public function create()
	{
		...
		if (isStoryMode)
			...
			detailsText = "Freeplay (Deleted from main menu idfk what ur talkin bout)";
