	...
	override public function create():Void
	{
		...
		if(ClientPrefs.data.checkForUpdates && !closedState) {
			...
			http.onData = function (data:String)
			{
				...
				var curVersion:String = MainMenuState.molliPsychEngineVersion.trim();
				trace('version online: ' + updateVersion + ', your version: ' + curVersion);
				if(updateVersion != curVersion) {
					trace('versions arent matching! initializing OutdatedState.hx...');
					mustUpdate = true;
				}
			}
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['x86dbg', 'BamzuYY', 'Dannil', 'Leoyosh202'], 40);
					#else
				...
				case 6:
					#if PSYCH_WATERMARKS
					createCoolText(['This shit is', 'not mine:'], -40);
					#else
					createCoolText(['In association', 'with'], -40);
					#end
				case 8:
					addMoreText('this shitty newgrounds thing', -40);
					ngSpr.visible = true;
				case 9:
					deleteCoolText();
					ngSpr.visible = false;
				...
				case 15:
					addMoreText('VS');
				case 16:
					addMoreText('Molli 	Overhaul'); // credTextShit.text += '\nFunkin';
