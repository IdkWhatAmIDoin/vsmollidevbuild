...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("Looking at who created the game with Molli trying to stuff her into a link.", null);
		#end
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['VS Molli OVERHAUL Team'],
			['x86dbg or Dima',      'dima',             'Mod Director of VS Molli OG and VS Molli OVERHAUL',         'https://www.youtube.com/@dixroblox',  'FFD700'],
			['BamzuYY',             'bamzuyy',          'Second Charter of VS Molli Overhaul./n i wish he program',  '',                                    '008000'],
			['Not hired yet',       '',                 'Voices Sema. Not hired yet. This is subject to change.',    '',                                    '000000'],
			['Not hired yet',       '',                 'Voices Betti. Not hired yet. This is subject to change.',   '',                                    '000000'],
			['Not hired yet',       '',                 'Voices Mailo. Not hired yet. This is subject to change.',   '',                                    '000000'],
			['Dannil',              'liagushka',        'Voices Molli.',		                                     '',                                    '008000'],
			['Leoyosh202',          'leoyosh',          'Artist/Animator of VS Molli Overhaul.',                     '',                                    '008000'],
			[''],
			['VS Molli OG Team'],
			['x86dbg or Dima',      'dima',             'Mod Director of VS Molli OG and VS Molli OVERHAUL',         'https://www.youtube.com/@dixroblox',  'FFD700'],
			[''],
